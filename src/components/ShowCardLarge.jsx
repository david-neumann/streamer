  ...
  return (
    <Link to={`/showdetails/${props.id}`}>
      <img
        ...
        className='h-[315px] min-w-[225px] object-cover aspect-poster rounded-xl shadow-even xl:h-[364px] xl:min-w-[260px] xl:transition-all xl:duration-300 lg:transition-all lg:duration-300'
