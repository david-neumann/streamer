...
const SearchResults = () => {
  ...
  return (
    <>
      <div className='flex items-center transition-all lg:mx-10 xl:mx-16'>
        <Link to='/'>
          <img
      ...
      {searchResultsElements.length > 0 ? (
        <main className='m-6 transition-all sm:mx-12 md:mx-16 lg:mx-24 xl:mx-36'>
          {searchResultsElements}
        </main>
      ) : (
        <Link to='/'>
          <div className='h-screen w-7/8 px-8 text-center sm:px-12 md:px-16 xl:px-20 transition-all'>
